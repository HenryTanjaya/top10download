package com.example.asus.top10download;
...
public class MainActivity extends AppCompatActivity {
        ...
        switch (id){
            ...
            case R.id.mnu25:
                if(!item.isChecked()){
                    ...
                    Log.d(TAG, "onOptionsItemSelected: "+item.getTitle()+" setting limit to "+feedLimit);
                }else{
    ...
    //save state after activity destroy rotation
    @Override
...
//                Log.d(TAG, "downloadXML: Response code"+response);
                ...
                Log.e(TAG, "downloadXML: Connection problem"+e.getMessage() );
            } catch (SecurityException e){
                Log.e(TAG, "downloadXML: Security error"+e.getMessage() );
            }
